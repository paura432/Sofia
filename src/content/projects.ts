...
export const projects: PortfolioProject[] = [
  ...
  // ─── Proyectos fotográficos — publicados sin año (preview editorial) ─────────
  // year: "Pendiente" → no se muestra en UI (`publishableYear`).
  {
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        width: 2351,
        height: 2800,
        blurDataURL: "data:image/webp;base64,UklGRrQAAABXRUJQVlA4IKgAAABQBQCdASoUABgAPu1sq1EppiOiqAqpMB2JaQAFEB7riFN8A+8o4xO++4bUHaTkxA5q4YAA/tOv+Epq+qKJusV5gaSmwryoMRjf3iM7++laTycvEYO8duA3SXnIkGrvLHQGpikP1grSmKXyahm9aosT3wGc+GZ2FVEwzd0SPILUjKv0+M8z2JhW5gKThlp2Jy7BKEO4KChOxolJwOrJrAT2Bm02nzEAAAA=",
        layout: "portrait",
        position: 7,
        altKey: "m07",
        captionKey: "m07",
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        height: 1867,
        aspectRatio: "3:2",
        blurDataURL: "data:image/webp;base64,UklGRpAAAABXRUJQVlA4IIQAAAAQBACdASoYABAAPu1mqk4ppaOiMAgBMB2JZgCdDBAAKHmGjRrXCjMfAAD+8qa+TLyqpcXN/xSyB5rKE+Td1rb2rS9aFdjMM0XQZ+LqkMWhRFiMc5KPQL13uDJf0D8NScxbu4UzUsK0hWgNsiDaQgzNPaZdLd2RSl1SRpTEZsncGnUqAAA=",
        layout: "wide",
        position: 5,
        altKey: "c05",
        captionKey: "c05",
      },
      {
        ...
        height: 1867,
        aspectRatio: "3:2",
        blurDataURL: "data:image/webp;base64,",
        layout: "pair",
        position: 6,
        altKey: "c06",
        captionKey: "c06",
      },
      {
        ...
        height: 1867,
        aspectRatio: "3:2",
        blurDataURL: "data:image/webp;base64,UklGRpgAAABXRUJQVlA4IIwAAADQBACdASoYABAAPu1kqU2ppaOiMAgBMB2JQBOmUGWTT/i13G+b0vFk5svSlzWD8AD+54RdFp8UNEW+5LTzQ9IvR1deNih6IMDnjCwwgwmkXY+vIjAdj3NqJAWF+JgHr8Pz/9i13Wbo0WjG+Ji+IzGqe5VHBw97WdRg7scNtzs5c+qa8MX6Eh70xA2gAA==",
        layout: "pair",
        position: 7,
        altKey: "c07",
        captionKey: "c07",
